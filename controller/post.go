...
// GetPostListHandler 获取帖子列表中的处理函数
...
// @Param object query modules.ParamPostList false "查询参数"
// @Security ApiKeyAuth
// @Success 200 {object} _ResponsePostList
// @Router /posts2 [get]
func GetPostListHandler2(c *gin.Context)  {
	// GetPostListHandler2 获升级版帖子列表接口
	// 根据前端传来的参数动态的获取帖子列表
	// 按创建时间排序 或者按照 分数排序
	// 1、获取参数
	// 2、去redis查询id列表
	...
	//c.ShouldBindJSON()   如果请求中携带的是json格式的数据，才能使用这个方法获取到数据
